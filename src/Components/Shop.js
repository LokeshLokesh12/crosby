                ...
                <ul>
                    ...
                    <li>
                        <a href="/products?id=4">
                            <img src="./images/Ecomm_17_Snake_001.jpg" alt=""/>
                            <h2>Snake</h2>
                            <p>from $12.00</p>
                        </a>
                    </li>
                    <li>
                        <a href="/products?id=5">
                            <img src="./images/Ecomm_18_Palm_004.jpg" alt=""/>
                            <h2>Palm</h2>
                            <p>from $30.00</p>
                        </a>
                    </li>
                    <li>
                        <a href="/products?id=6">
                            <img src="./images/Ecomm_04_Orchid_005.jpg" alt=""/>
                            <h2>Orchid</h2>
                            <p>from $30.00</p>
                        </a>
                    </li>
                    <li>
                        <a href="/products?id=7">
                            <img src="./images/Ecomm_03_CalatheaPink_006.jpg" alt=""/>
                            <h2>Calathea Pink</h2>
                            <p>from $10.00</p>
                        </a>
                    </li>
                    <li>
                        <a href="/products?id=8">
                            <img src="./images/Ecomm_13_MaidenHair_006.jpg" alt=""/>
                            <h2>Maiden Hair</h2>
                            <p>from $25.00</p>
                        </a>
                    </li>
                    <li>
                        <a href="/products?id=9">
                            <img src="./images/Ecomm_16_Cactus2_005.jpg" alt=""/>
                            <h2>Cactus</h2>
                            <p>from $50.00</p>
                        </a>
                    </li>
                    <li>
                        <a href="/products?id=10">
                            <img src="./images/Ecomm_07_Fern_003.jpg" alt=""/>
                            <h2>Fern</h2>
                            <p>from $25.00</p>
                        </a>
                    </li>
